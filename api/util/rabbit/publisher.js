...
exports.publishInQueue = function publishInQueue (conn, queueName) {
  ...
  return conn.createChannel().then(ch => {
    ch.sendToQueue(queueName, Buffer.from(payload), {headers: msgHeaders, deliveryMode: deliveryModeOption, priority: 0, replyTo: 'me', correlationId: uuid(), contentType: 'application/json', contentEncoding: 'utf-8'})
  })
}
